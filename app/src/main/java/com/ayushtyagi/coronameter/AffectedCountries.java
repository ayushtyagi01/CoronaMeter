...
import static com.ayushtyagi.coronameter.R.layout.activity_affected_countries;
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i=0;i<jsonArray.length();i++){
                                ...
                                countryModel = new CountryModel(flagUrl,countryname,cases,deaths,todaydeaths,todayCases,recovered,active,critical);
